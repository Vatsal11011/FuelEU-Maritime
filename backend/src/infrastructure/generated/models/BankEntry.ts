...
// @ts-nocheck 
/*
 * This file exports the `BankEntry` model and its related types.
 *
...
export type BankEntryAvgAggregateOutputType = {
  year: number | null
  amountGco2eq: runtime.Decimal | null
}
...
export type GetBankEntryAggregateType<T extends BankEntryAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBankEntry[P]>
    : Prisma.GetScalarType<T[P], AggregateBankEntry[P]>
}
...
type GetBankEntryGroupByPayload<T extends BankEntryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BankEntryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BankEntryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BankEntryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BankEntryGroupByOutputType[P]>
      }
    >
  >
...
export type BankEntryWhereInput = {
  ...
  amountGco2eq?: Prisma.DecimalFilter<"BankEntry"> | runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type BankEntryScalarWhereWithAggregatesInput = {
  ...
  amountGco2eq?: Prisma.DecimalWithAggregatesFilter<"BankEntry"> | runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type BankEntryCreateInput = {
  ...
  shipId: string
  year: number
  amountGco2eq: runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type BankEntryUpdateInput = {
  ...
  amountGco2eq?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type BankEntryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "shipId" | "year" | "amountGco2eq", ExtArgs["result"]["bankEntry"]>
...
export type BankEntryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface BankEntryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends BankEntryCountArgs>(
    args?: Prisma.Subset<T, BankEntryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BankEntryCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, BankEntryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBankEntryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface BankEntryFieldRefs {
  ...
  readonly amountGco2eq: Prisma.FieldRef<"BankEntry", 'Decimal'>
}

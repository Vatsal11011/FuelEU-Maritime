...
// @ts-nocheck 
/*
 * This file exports the `ShipCompliance` model and its related types.
 *
...
export type GetShipComplianceAggregateType<T extends ShipComplianceAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateShipCompliance[P]>
    : Prisma.GetScalarType<T[P], AggregateShipCompliance[P]>
}
...
type GetShipComplianceGroupByPayload<T extends ShipComplianceGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ShipComplianceGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ShipComplianceGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ShipComplianceGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ShipComplianceGroupByOutputType[P]>
      }
    >
  >
...
export type ShipComplianceWhereInput = {
  ...
  cbGco2eq?: Prisma.DecimalFilter<"ShipCompliance"> | runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type ShipComplianceScalarWhereWithAggregatesInput = {
  ...
  cbGco2eq?: Prisma.DecimalWithAggregatesFilter<"ShipCompliance"> | runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type ShipComplianceCreateInput = {
  ...
  shipId: string
  year: number
  cbGco2eq: runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type ShipComplianceUpdateInput = {
  ...
  cbGco2eq?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string
}
...
export type ShipComplianceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "shipId" | "year" | "cbGco2eq", ExtArgs["result"]["shipCompliance"]>
...
export type ShipComplianceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface ShipComplianceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends ShipComplianceCountArgs>(
    args?: Prisma.Subset<T, ShipComplianceCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ShipComplianceCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ShipComplianceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetShipComplianceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface ShipComplianceFieldRefs {
  ...
  readonly cbGco2eq: Prisma.FieldRef<"ShipCompliance", 'Decimal'>
}
